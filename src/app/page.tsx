    ...
    <div className='page_container'>
      ...
      <div className='paragraph_container'>
        <p className='paragraph_content'>
          ...
          while they wait to be placed in a &quot;furever&quot; home. Located at the corner of Durban Avenue and Flora
          Avenue in Hopatcong, NJ, the <strong>Hopatcong Animal Shelter</strong> is run by Gianna DiMateo, HLEO, and
